...
export const capabilities = [
  {
    title: "Requirements & Business Rules",
    description:
...
export const approach = [
  {
    title: "Investigate",
    description: "Observe the current state. Follow the work and the evidence.",
  },
  {
    title: "Model",
    description:
...
export const experience = [
  {
    ...
    company: "Waypoint Media Co.",
    dates: "2024–2025",
  },
  {
    title: "VP, Performance & Connected Media",
    company: "Boldly Grow Media",
    dates: "2021–2024",
  },
  {
    title: "Marketing Director / Executive Leadership Team",
    company: "MagMod",
    dates: "2017–2020",
  },
];
...
export const supportingWork = [
  {
    title: "EOS / Level 10 Operating System Implementation",
    company: "MagMod",
    category: "Organizational operations",
    summary:
      "Helped implement EOS across the company and operationalized the Level 10 meeting process for executive leadership and the marketing organization. Led recurring executive L10 meetings, maintained supporting operating documents, tracked issues and commitments, and facilitated the structured process used to surface, prioritize, discuss, and resolve organizational problems.",
  },
  {
    title: "Monthly Reporting Standardization",
    company: "Boldly Grow Media",
  ...
  {
    title: "Safe Transaction Automation",
    company: "Vector",
    category: "Rules & authorization",
    summary:
  ...
  {
    title: "Production Migration Discipline",
    company: "Vector",
